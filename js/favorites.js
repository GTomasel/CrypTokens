    ...
    const data = await response.json()
        ...
        if (loggedUserCredentials !== undefined && loggedUserCredentials.logged == 1){
            ...
            for (let i = 0; i < loggedUserCredentials.favorites.length; i++){
                ...
                if(loggedUserCredentials.favorites[i] == coinID){
                    ...
                    document.getElementById('favStar'+i).classList.add('favStarChecked'); 
                    document.getElementById('favStar'+i).classList.remove('favStar');
        ...
        checkbox.addEventListener("click", e => {
            if(e.target.checked == true){
                ...
                document.getElementById('favStar'+id).classList.add('favStarChecked'); 
                document.getElementById('favStar'+id).classList.remove('favStar');
